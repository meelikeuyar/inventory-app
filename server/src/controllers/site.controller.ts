...
export async function getSites(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
  try {
    const data = await siteService.findAll(String(req.params.projectId), req.userId!);
    res.json(data);
  } catch (err) { next(err); }
}
...
export async function createSite(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
  try {
    const data = await siteService.create(String(req.params.projectId), req.userId!, req.body);
...
export async function updateSite(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
  try {
    const data = await siteService.update(String(req.params.projectId), String(req.params.id), req.userId!, req.body);
    res.json(data);
  } catch (err) { next(err); }
}
...
export async function deleteSite(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
  try {
    const data = await siteService.delete(String(req.params.projectId), String(req.params.id), req.userId!);
    res.json(data);
  } catch (err) { next(err); }
}
